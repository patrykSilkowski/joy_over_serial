...
$(OUTPUT_DIRECTORY)/nrf52840_xxaa.out: \
  LINKER_SCRIPT  := $(SDK_ROOT)/examples/ble_peripheral/ble_app_uart/pca10056/s140/armgcc/ble_app_uart_gcc_nrf52.ld
...
# Optimization flags
# -O3 changed to -O0 due to the debugging issues
OPT = -O0 -g3
